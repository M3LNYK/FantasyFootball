...
extract_player_stats_links <- function(competition_url) {
  tryCatch({
    ...
    api <- "https://www.fotmob.com/_next/data/bhtACeKZ4e_Lvxde8cpLT/en/leagues/47/stats/premier-league/players.json?lng=en&id=47&tab=stats&slug=premier-league&slug=players"
    main_json <- GET(api,
